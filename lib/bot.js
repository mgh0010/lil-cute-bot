...
function getCalendar(todayString, message) {
    ...
    function getWeather() {
        let apiKey = 'e0ad9a5d7731f07a87d6ac20e6379ca7';
        let city = 'auburn';
        let cityId = '4830796';
        ...
        request(url, function (err, response, body) {
          if(err){
            ...
            weatherInfo = `It's ${weather.weather[0].main} with a temp of ${weather.main.temp} degrees in ${weather.name}!`;
    ...
    function checkMessage(message) {
        ...
        else if (messageText && heyRegex.test(messageText)) {return 'Hi. I\'m cute';}
